...
class GlassesAdapter(val context: Context, val drinks: List<Drinks>) : RecyclerView.Adapter<GlassesAdapter.GlassHolder>() {
    ...
    inner class GlassHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
